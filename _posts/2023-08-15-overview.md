...
<div class="profile-wrapper">
    <img src="../public/profile.jpg" alt="Profile Avatar" style="width:200px;height:250px;"/>
    <div>
        <ul class="no-style-ul" style="margin-bottom: 8px;">
            <li class="lead-li"> Graduate Student</li>
            <li class="lead-li"> Computer Science and Engineering</li>
            <li class="lead-li"> Louisiana State University</li>
            <li class="lead-li"> <a href="mailto:sshre35@lsu.edu">sshre35@lsu.edu</a></li>
        </ul>
