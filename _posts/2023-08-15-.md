...
<ul class="no-style-ul overview-ul education-ul" style="margin-bottom: 8px;">
    <li>
        <div class="h-justified-flex">
            <a class="paper-link" href="https://conf.researchr.org/track/mobilesoft-2024/mobilesoft-2024-research-track" target="_blank">
                <p style="color: black;margin:0; padding: 0;">Generating Rate Features for Mobile Applications
                </p>
             </a>
        </div>
        <div>
